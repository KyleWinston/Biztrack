...
public class BizTrack extends PApplet {
...
public void getDetails(String what, String where, int page){
 try{
...
public void loopBackIn(int pageToStart){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "BizTrack" };
    if (passedArgs != null) {
